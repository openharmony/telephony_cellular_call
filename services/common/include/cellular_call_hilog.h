...
#ifndef TELEPHONY_CELLULAR_CALL_HILOG_WRAPPER_H
#define TELEPHONY_CELLULAR_CALL_HILOG_WRAPPER_H
...
static constexpr OHOS::HiviewDFX::HiLogLabel LOG_LABEL = {LOG_CORE, LOG_DOMAIN, "CellularCallService"};
...
#endif // TELEPHONY_CELLULAR_CALL_HILOG_WRAPPER_H