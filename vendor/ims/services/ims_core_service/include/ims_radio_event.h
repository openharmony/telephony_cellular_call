...
enum ImsRadioEvent {
    ...
    IMS_RADIO_IS_EMERGENCY_NUMBER,
    IMS_RADIO_GET_CALL_STATUS,
    IMS_RADIO_GET_CALL_DATA,
    IMS_RADIO_CALL_RINGBACK,
    IMS_RADIO_GET_ECC_CALL_LIST,
    ...
    IMS_RADIO_SET_SWITCH_ENHANCE_MODE,
    IMS_RADIO_GET_SWITCH_ENHANCE_MODE,
    IMS_RADIO_SET_MUTE,
    IMS_RADIO_GET_MUTE,
    IMS_SRVCC_STATUS,
