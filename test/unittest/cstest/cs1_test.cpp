...
HWTEST_F(Cs1Test, cellular_call_SetEmergencyCallList_0101, Function | MediumTest | Level3)
{
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_GE(telephonyService->SetEmergencyCallList(SIM1_SLOTID, eccVec), TELEPHONY_SUCCESS);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_GE(telephonyService->SetEmergencyCallList(SIM2_SLOTID, eccVec), TELEPHONY_SUCCESS);
    }
